{
  ...
  class BinaryTree {
     ...
     */
    numberOfFullNodesSol1(root = this.root) {
      if (root === null || (root.left === null || root.right === null)) {
        return 0;
      }
      return (
        this.numberOfFullNodesSol1(root.left) +
        this.numberOfFullNodesSol1(root.right) +
        1
      );
    }
     ...
     * Space Complexity: O(n)
     */
    numberOfFullNodesSol2(root = this.root) {
