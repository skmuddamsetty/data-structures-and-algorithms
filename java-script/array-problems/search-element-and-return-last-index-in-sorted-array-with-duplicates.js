 ...
 * ensure that mid+1 (if it exists) is greater than desired element.
 * This will give us last index of the desired element.
 *
 ...
 */
{
  ...
  searchElementAndReturnLastIndex([0, 1, 1, 2, 2, 4, 5, 5, 5, 5], 1);
}
